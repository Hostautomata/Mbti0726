...
<link href="/resources/css/community_list.css" rel="stylesheet">
			...
			<tbody>
				...
				<!-- 예시 -->
							<tr>
								...
								<td>Q&A</td>
								<td><a href="community_onelist.do">레오파드 게코 질문 합니다.</a></td>
								<td>파충류</td>
							</tr>
			</tbody>
					...
					<td colspan="2" class="buttonline">
						<ol class="paging" >
							...
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="comunity_list.do?cPage=${pvo.beginBlock-pvo.pagePerBlock}">이전으로</a></li>
								</c:otherwise>
							</c:choose>
							<!-- 블록안에 들어간 페이지번호들 -->
							<c:forEach begin="${pvo.beginBlock}" end="${pvo.endBlock }"
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a
											href="comunity_list.do?cPage=${k}">${k}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<!-- 다음 -->
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="comunity_list.do?cPage=${pvo.beginBlock+pvo.pagePerBlock}">다음으로</a></li>
								</c:otherwise>
							</c:choose>
						</ol>
					</td>
